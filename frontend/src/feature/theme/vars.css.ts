...
const defaultRole = {
  primary: {
    ...
    containerHighest: defaultColor.blue[200],
  ...
  secondary: {
    ...
    containerHighest: defaultColor.gray[200],
  ...
  error: {
    ...
    containerHighest: defaultColor.red[200],
    hover: defaultColor.red[600],
  },
  warn: {
    default: defaultColor.yellow[500],
    text: defaultColor.gray[50],
    container: defaultColor.yellow[50],
    containerHigh: defaultColor.yellow[100],
    containerHighest: defaultColor.yellow[200],
    hover: defaultColor.yellow[600],
  },
  success: {
    default: defaultColor.green[500],
    text: defaultColor.gray[50],
    container: defaultColor.green[50],
    containerHigh: defaultColor.green[100],
    containerHighest: defaultColor.green[200],
    hover: defaultColor.green[600],
  },
  surface: {
...
export const defaultLightTheme = {
  ...
  role: {
    primary: {
      ...
      container: vars.color.blue[50],
      containerHigh: vars.color.blue[100],
      containerHighest: vars.color.blue[200],
    ...
    secondary: {
      ...
      containerHigh: vars.color.gray[100],
      containerHighest: vars.color.gray[200],
      hover: vars.color.gray[300],
    },
    error: {
      default: vars.color.red[500],
      text: vars.color.gray[50],
      container: vars.color.red[50],
      containerHigh: vars.color.red[100],
      containerHighest: vars.color.red[200],
      hover: vars.color.red[600],
    },
    warn: {
      default: vars.color.yellow[500],
      text: vars.color.gray[50],
      container: vars.color.yellow[50],
      containerHigh: vars.color.yellow[100],
      containerHighest: vars.color.yellow[200],
      hover: vars.color.yellow[600],
    },
    success: {
      default: vars.color.green[500],
      text: vars.color.gray[50],
      container: vars.color.green[50],
      containerHigh: vars.color.green[100],
      containerHighest: vars.color.green[200],
...
export const defaultDarkTheme = {
  ...
  role: {
    primary: {
      default: vars.color.blue[500],
      text: vars.color.gray[50],
      container: vars.color.blue[950],
      containerHigh: vars.color.blue[900],
      containerHighest: vars.color.blue[800],
      hover: vars.color.blue[400],
    },
    secondary: {
      default: vars.color.gray[700],
      text: vars.color.gray[50],
      container: vars.color.gray[950],
      containerHigh: vars.color.gray[900],
      containerHighest: vars.color.gray[800],
      hover: vars.color.gray[600],
    },
    error: {
      default: vars.color.red[500],
      text: vars.color.gray[50],
      container: vars.color.red[950],
      containerHigh: vars.color.red[900],
      containerHighest: vars.color.red[800],
      hover: vars.color.red[400],
    },
    warn: {
      default: vars.color.yellow[500],
      text: vars.color.gray[50],
      container: vars.color.yellow[950],
      containerHigh: vars.color.yellow[900],
      containerHighest: vars.color.yellow[800],
      hover: vars.color.yellow[400],
    },
    success: {
      default: vars.color.green[500],
      text: vars.color.gray[50],
      container: vars.color.green[950],
      containerHigh: vars.color.green[900],
      containerHighest: vars.color.green[800],
      hover: vars.color.green[400],
    },
    surface: {
      default: vars.color.gray[900],
      text: vars.color.gray[50],
      high: vars.color.gray[800],
      highest: vars.color.gray[700],
    },
    text: {
      default: vars.color.gray[50],
      caption: vars.color.gray[500],
      disabled: vars.color.gray[600],
    },
  },
};
